...
<div class="collapse" id="ui-basic">
  <ul class="nav flex-column sub-menu">
    <li class="nav-item"> <a class="nav-link" href="{{ url('/Novel')}}">Novel</a></li>
    <li class="nav-item"> <a class="nav-link" href="{{ url('/biografi')}}">Biografi</a></li>
    <li class="nav-item"> <a class="nav-link" href="{{ url('/komik')}}">Komik</a></li>
  </ul>
</div>
</li>
<li class="nav-item">
...
<div class="collapse" id="form-elements">
  <ul class="nav flex-column sub-menu">
    <li class="nav-item"><a class="nav-link" href="{{ url('/store')}}">Tambahkan Buku</a></li>
  </ul>
</div>
</li>
<li class="nav-item">
        ...
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card tale-bg">
            <div class="card-people mt-auto">
              <img src="{{ asset('src')}}/assets/images/dashboard/people.svg" alt="people">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <ul class="icon-data-list">
                <li>
                  <div class="d-flex">
                    <img src="{{ asset('src')}}/assets/images/faces/face1.jpg" alt="user">
                    <div>
                ...
                <li>
                  <div class="d-flex">
                    <img src="{{ asset('src')}}/assets/images/faces/face2.jpg" alt="user">
                    <div>
                ...
                <li>
                  <div class="d-flex">
                    <img src="{{ asset('src')}}/assets/images/faces/face3.jpg" alt="user">
                    <div>
                ...
                <li>
                  <div class="d-flex">
                    <img src="{{ asset('src')}}/assets/images/faces/face4.jpg" alt="user">
                    <div>
                ...
                <li>
                  <div class="d-flex">
                    <img src="{{ asset('src')}}/assets/images/faces/face5.jpg" alt="user">
                    <div>
